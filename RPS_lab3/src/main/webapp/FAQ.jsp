...
<div class="main-info">
    ...
    <h1>-Основной функционал: Регистрация/Авторизация пользователя, Ввод массива целых чисел, его схоранение и сортировка при помощи алгоритма CombSort </h1>
    <h1>-Вариант 16</h1>
    <h1>-Шишкин Георгий Константинович 445гр</h1>
</div>
</body>
<script>
